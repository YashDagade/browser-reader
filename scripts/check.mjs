...
for(const file of [manifest.background.service_worker,manifest.options_page,...Object.values(manifest.icons),'extractor.js','ui.js','content.js','offscreen.html','offscreen.js']){
